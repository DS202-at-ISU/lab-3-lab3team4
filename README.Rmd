...
#Find total number of first deaths
#put total number of first returns over that
...
nrow(yReturn)
#This provides the number of times an Avenger returned from their first death

nReturn <- filter(deathsNReturns, Return == "NO", na.rm = TRUE)
nrow(nReturn)
#This provides the number of times an Avenger did Not return from their first death
